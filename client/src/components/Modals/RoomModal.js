...
import { ADD_ROOM, UPDATE_ROOM } from '../../graphql/mutations/roomMutation'
...
const RoomModal = (props) => {
    ...
    const propsRoom = props.RoomModal
    ...
    return (
        <ModalContainer>
            <ModalBox className="modal-box">
                {!loading ? (
                    <>
                        <CloseIcon className="close-icon" onClic={() => props.setRoomModal(false)} />
                        ...
                        <GridContainer>
                            {room.images.map((image, idx) => (
                                <ImageUpload key={image.uuid}
                                    ...
                                    data={image}
                                    styles={{ height: '160px' }}
                                    setImageURL={(val) => changeItem(val, idx)}
