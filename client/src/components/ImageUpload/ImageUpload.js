...
import BlankkImg from "../../assets/hotel.png";
...
const ImageUpload = (props) => {
    ...
    const [src, setSrc] = useState(imageUrl ? imageUrl : BlankkImg);
    ...
    const [preview, setPreview] = useState(''); // show image preview
    const [imageFile, setImageFile] = useState({}); // for setting image file after upload
            ...
            {popup && (
                <ModalContainer>
                    <ModalBox>
                        {src && (
                            <>
                                <ReactCrop src ={scr} onImageLoaded={setImage}
