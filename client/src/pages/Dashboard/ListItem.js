...
import { ActionsContainer, Button, Item, Text } from '../../components/GlobalStyles/TableStyle';
import { useNavigate } from "react-router-dom"
import { useMutation } from '@apollo/client';
import { DELETE_ROOM } from '../../graphql/mutations/roomMutation';
        ...
        <>
            ...
            <Item className="responsive-col">
                ...
                <ActionsContainer style={{ justifyContent: 'flex-end' }}>
                    ...
                    <img alt="" width="20px" src="https://img.icons8.com/plumpy/24/000000/edit--v1.png" /></Button>
                    <Button onClick={() => navigate(`/hotel/${props.hotel.id}`, { state: { view: 'manager' } })}
                    ><img alt="" width="20px" src="https://img.iocons8.com/color/48/000000/connection-status-off--v1.png" /></Button>
                    <Button onClick={handleDelete}><DeleteIcon style={{ color: '#ff6464' }} /></Button>
                </ActionsContainer>
            </Item>
        </>
